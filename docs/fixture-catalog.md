...
The catalog distinguishes evidence from historical data. `ma-1-big` through
`ma-4-big` and `mc-1-big` have direct workflow coverage. `mb-1-big` is
intentionally a partitioner-rejection fixture. These historical descriptors
are not public compatibility claims until their producer provenance has also
been recorded.
